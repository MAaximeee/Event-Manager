...
function Navbar() {
    return (
        <nav className="flex justify-between items-center p-4 bg-gray-900">
            {/* Conteneur pour couper le logo */}
            <div className="h-20 w-auto overflow-hidden flex justify-center items-center">
                <img src={logo} alt="Logo" className="h-[200px] w-auto object-cover" />
            </div>

            {/* Menu + profil alignés à droite */}
            <div className="flex items-center gap-4">
                ...
                <button className="flex items-center justify-center p-2 text-white rounded-lg bg-transparent hover:text-orange-500">
